...
final class DrawCriticalImpactPainter extends CustomPainter {
  const DrawCriticalImpactPainter(this.progress);
  ...
  @override
  bool shouldRepaint(covariant DrawCriticalImpactPainter oldDelegate) {
