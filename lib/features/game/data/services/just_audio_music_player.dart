...
final class JustAudioMusicPlayer implements MusicPlayer {
  ...
  Future<void> _setVolume(double volume) {
    return _player.setVolume(GameAudioSettings.effectiveOutputVolume(volume));
  }
  ...
  Future<bool> _fade({
    ...
    final target = GameAudioSettings.effectiveOutputVolume(to);
    ...
    for (var index = 1; index <= steps; index++) {
      ...
      await _player.setVolume(
        volume.clamp(0, GameAudioSettings.maxOutputVolume).toDouble(),
      );
